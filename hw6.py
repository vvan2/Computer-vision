...
#%% make Class and Callback Function
class DogSpeciesRecognition(QMainWindow):
    ...
    def recognitionFunction(self):
        ...
        res=cnn.predict(x)[0] #probabilities of 120 classes
        #print(res)
        top5=np.argsort(-res)[0:5] #ascending  sort => -res: decending of absoute value
...
app=QApplication(sys.argv) #sys.argv: path of python file
